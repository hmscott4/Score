...
INSERT [dbo].[Config] ([ConfigName], [ConfigValue], [dbAddDate], [dbAddBy], [dbModDate], [dbModBy]) 
VALUES (N'ProcessLogRetainDays', N'90', GETDATE(), SUSER_SNAME(), GETDATE(), SUSER_SNAME())
GO
INSERT [dbo].[Config] ([ConfigName], [ConfigValue], [dbAddDate], [dbAddBy], [dbModDate], [dbModBy]) 
VALUES (N'SyncHistoryRetainDays', N'90', GETDATE(), SUSER_SNAME(), GETDATE(), SUSER_SNAME())
GO
INSERT [dbo].[Config] ([ConfigName], [ConfigValue], [dbAddDate], [dbAddBy], [dbModDate], [dbModBy]) 
VALUES (N'EventLogRetainDays', N'7', GETDATE(), SUSER_SNAME(), GETDATE(), SUSER_SNAME())
GO
INSERT [dbo].[Config] ([ConfigName], [ConfigValue], [dbAddDate], [dbAddBy], [dbModDate], [dbModBy]) 
VALUES (N'DatabaseSizeDailyRetainDays', N'1825', GETDATE(), SUSER_SNAME(), GETDATE(), SUSER_SNAME())
GO
INSERT [dbo].[Config] ([ConfigName], [ConfigValue], [dbAddDate], [dbAddBy], [dbModDate], [dbModBy]) 
VALUES (N'DatabaseSizeRawRetainDays', N'30', GETDATE(), SUSER_SNAME(), GETDATE(), SUSER_SNAME())
GO
INSERT [dbo].[Config] ([ConfigName], [ConfigValue], [dbAddDate], [dbAddBy], [dbModDate], [dbModBy]) 
VALUES (N'LogicalVolumeSizeDailyRetainDays', N'1825', GETDATE(), SUSER_SNAME(), GETDATE(), SUSER_SNAME())
GO
INSERT [dbo].[Config] ([ConfigName], [ConfigValue], [dbAddDate], [dbAddBy], [dbModDate], [dbModBy]) 
VALUES (N'LogicalVolumeSizeRawRetainDays', N'30', GETDATE(), SUSER_SNAME(), GETDATE(), SUSER_SNAME())
GO
INSERT [dbo].[Config] ([ConfigName], [ConfigValue], [dbAddDate], [dbAddBy], [dbModDate], [dbModBy]) 
VALUES (N'WebApplicationResponseDailyRetainDays', N'365', GETDATE(), SUSER_SNAME(), GETDATE(), SUSER_SNAME())
GO
INSERT [dbo].[Config] ([ConfigName], [ConfigValue], [dbAddDate], [dbAddBy], [dbModDate], [dbModBy]) 
VALUES (N'WebApplicationResponseRawRetainDays', N'30', GETDATE(), SUSER_SNAME(), GETDATE(), SUSER_SNAME())
GO
INSERT [dbo].[Config] ([ConfigName], [ConfigValue], [dbAddDate], [dbAddBy], [dbModDate], [dbModBy]) 
VALUES (N'ConfigurationHistoryRetainDays', N'21', GETDATE(), SUSER_SNAME(), GETDATE(), SUSER_SNAME())
GO
INSERT [dbo].[Config] ([ConfigName], [ConfigValue], [dbAddDate], [dbAddBy], [dbModDate], [dbModBy]) 
VALUES (N'StoreConfigurationHistory', N'1', GETDATE(), SUSER_SNAME(), GETDATE(), SUSER_SNAME())
GO
INSERT [dbo].[Config] ([ConfigName], [ConfigValue], [dbAddDate], [dbAddBy], [dbModDate], [dbModBy]) 
VALUES (N'DefaultTimeZoneDisplayName', N'(UTC-05:00) Eastern Time (US & Canada)', GETDATE(), SUSER_SNAME(), GETDATE(), SUSER_SNAME())
GO
INSERT [dbo].[Config] ([ConfigName], [ConfigValue], [dbAddDate], [dbAddBy], [dbModDate], [dbModBy]) 
VALUES (N'OrganizationDisplayName', N'ABCD Corporation', GETDATE(), SUSER_SNAME(), GETDATE(), SUSER_SNAME())
GO
INSERT [dbo].[Config] ([ConfigName], [ConfigValue], [dbAddDate], [dbAddBy], [dbModDate], [dbModBy]) 
VALUES (N'DefaultTimeZoneCurrentOffset', N'-300', GETDATE(), SUSER_SNAME(), GETDATE(), SUSER_SNAME())
GO
INSERT [dbo].[Config] ([ConfigName], [ConfigValue], [dbAddDate], [dbAddBy], [dbModDate], [dbModBy]) 
...
* 2019/02/01
*/
INSERT [scom].[ObjectClass] ([ID], [Name], [DisplayName], [GenericName], [ManagementPackName], [Description], [DistributedApplication], [Active], [dbAddDate], [dbLastUpdate]) 
VALUES (N'722594ba-bc11-45d5-81a2-a6059ada4682', N'Microsoft.SQLServer.Windows.Database', N'MSSQL on Windows: Database', N'SQL Database', N'Microsoft.SQLServer.Windows.Discovery', N'SQL Database', 0, 1, GETDATE(), GETDATE())
GO
INSERT [scom].[ObjectClass] ([ID], [Name], [DisplayName], [GenericName], [ManagementPackName], [Description], [DistributedApplication], [Active], [dbAddDate], [dbLastUpdate]) 
VALUES (N'8def7ccc-ca28-c7ef-796f-644160e0b22a', N'Microsoft.SQLServer.Windows.DBEngine', N'MSSQL on Windows: DB Engine', N'SQL DB Engine', N'Microsoft.SQLServer.Windows.Discovery', N'SQL DB Engine', 0, 1, GETDATE(), GETDATE())
GO
INSERT [scom].[ObjectClass] ([ID], [Name], [DisplayName], [GenericName], [ManagementPackName], [Description], [DistributedApplication], [Active], [dbAddDate], [dbLastUpdate]) 
VALUES (N'6b1d1be8-ebb4-b425-08dc-2385c5930b04', N'Microsoft.SystemCenter.ManagementGroup', N'Operations Manager Management Group', N'Operations Manager Management Group', N'Microsoft.SystemCenter.Library', N'Operations Manager Management Group', 1, 1, GETDATE(), GETDATE())
GO
INSERT [scom].[ObjectClass] ([ID], [Name], [DisplayName], [GenericName], [ManagementPackName], [Description], [DistributedApplication], [Active], [dbAddDate], [dbLastUpdate]) 
VALUES (N'360e5a02-bc9e-0000-2614-1972e304088a', N'Microsoft.Unix.Computer', N'UNIX/Linux Computer', N'UNIX/Linux Computer', N'Microsoft.Unix.Library', N'UNIX/Linux Computer', 0, 0, GETDATE(), GETDATE())
GO
INSERT [scom].[ObjectClass] ([ID], [Name], [DisplayName], [GenericName], [ManagementPackName], [Description], [DistributedApplication], [Active], [dbAddDate], [dbLastUpdate]) 
VALUES (N'627f4dff-40f7-89d6-6d0d-71102b6e8cea', N'Microsoft.Windows.Cluster', N'Windows Cluster', N'Windows Cluster', N'Microsoft.Windows.Cluster.Library', N'Windows Cluster', 0, 1, GETDATE(), GETDATE())
GO
INSERT [scom].[ObjectClass] ([ID], [Name], [DisplayName], [GenericName], [ManagementPackName], [Description], [DistributedApplication], [Active], [dbAddDate], [dbLastUpdate]) 
VALUES (N'c2dbd9a8-c677-5ec7-735e-bc703e84b743', N'Microsoft.Windows.InternetInformationServices.WebServer', N'IIS Web Server', N'IIS Web Server', N'Microsoft.Windows.InternetInformationServices.CommonLibrary', N'IIS Web Server', 0, 1, GETDATE(), GETDATE())
GO
INSERT [scom].[ObjectClass] ([ID], [Name], [DisplayName], [GenericName], [ManagementPackName], [Description], [DistributedApplication], [Active], [dbAddDate], [dbLastUpdate]) 
VALUES (N'294f206e-08aa-6dc1-1bd7-a72ce272f365', N'Microsoft.Windows.InternetInformationServices.WebSite', N'IIS Web Site', N'IIS Web Site', N'Microsoft.Windows.InternetInformationServices.CommonLibrary', N'IIS Web Site', 0, 1, GETDATE(), GETDATE())
GO
INSERT [scom].[ObjectClass] ([ID], [Name], [DisplayName], [GenericName], [ManagementPackName], [Description], [DistributedApplication], [Active], [dbAddDate], [dbLastUpdate]) 
VALUES (N'40aa6fa1-a799-1dba-255c-d8d3ab8b33b6', N'Microsoft.Windows.Server.AD.Library.DomainControllerRole', N'Active Directory Domain Controller Computer Role', N'Domain Controller', N'Microsoft.Windows.Server.AD.Class.Library', N'Active Directory Domain Controller', 0, 1, GETDATE(), GETDATE())
GO
INSERT [scom].[ObjectClass] ([ID], [Name], [DisplayName], [GenericName], [ManagementPackName], [Description], [DistributedApplication], [Active], [dbAddDate], [dbLastUpdate]) 
VALUES (N'adf4f2cc-8380-9b9b-532e-20306371d65a', N'Microsoft.Windows.Server.AD.Library.Site', N'Active Directory Site', N'Active Directory Site', N'Microsoft.Windows.Server.AD.Class.Library', N'Active Directory Site', 0, 1, GETDATE(), GETDATE())
GO
INSERT [scom].[ObjectClass] ([ID], [Name], [DisplayName], [GenericName], [ManagementPackName], [Description], [DistributedApplication], [Active], [dbAddDate], [dbLastUpdate]) 
VALUES (N'8e0d6b90-4918-8db1-6dd2-89f5262133c7', N'Microsoft.Windows.Server.AD.Site', N'Active Directory Site', N'Active Directory Site', N'Microsoft.Windows.Server.AD.Library', N'Microsoft.Windows.Server.AD.Library', 0, 0, GETDATE(), GETDATE())
GO
INSERT [scom].[ObjectClass] ([ID], [Name], [DisplayName], [GenericName], [ManagementPackName], [Description], [DistributedApplication], [Active], [dbAddDate], [dbLastUpdate]) 
VALUES (N'10f38c20-64e5-06ea-6e54-a18c9226e0a3', N'Microsoft.Windows.Server.ClusterDisksMonitoring.ClusterDisk', N'Cluster Disk', N'Windows Logical Disk', N'Microsoft.Windows.Server.ClusterSharedVolumeMonitoring', N'Windows Logical Disk', 0, 1, GETDATE(), GETDATE())
GO
INSERT [scom].[ObjectClass] ([ID], [Name], [DisplayName], [GenericName], [ManagementPackName], [Description], [DistributedApplication], [Active], [dbAddDate], [dbLastUpdate]) 
VALUES (N'193cbd06-cbe3-e1fa-cb80-2773e7e772c9', N'Microsoft.Windows.Server.ClusterSharedVolumeMonitoring.ClusterSharedVolume', N'Cluster Shared Volume', N'Windows Logical Disk', N'Microsoft.Windows.Server.ClusterSharedVolumeMonitoring', N'Windows Logical Disk', 0, 1, GETDATE(), GETDATE())
GO
INSERT [scom].[ObjectClass] ([ID], [Name], [DisplayName], [GenericName], [ManagementPackName], [Description], [DistributedApplication], [Active], [dbAddDate], [dbLastUpdate]) 
VALUES (N'e817d034-02e8-294c-3509-01ca25481689', N'Microsoft.Windows.Server.Computer', N'Windows Server', N'Windows Server', N'Microsoft.Windows.Library', N'Windows Server', 0, 1, GETDATE(), GETDATE())
GO
INSERT [scom].[ObjectClass] ([ID], [Name], [DisplayName], [GenericName], [ManagementPackName], [Description], [DistributedApplication], [Active], [dbAddDate], [dbLastUpdate]) 
VALUES (N'486adddb-2eb8-819a-fa24-8f6ab3e29543', N'Microsoft.Windows.Server.LogicalDisk', N'Logical Disk (Server)', N'Windows Logical Disk', N'Microsoft.Windows.Server.Library', N'Windows Logical Disk', 0, 1, GETDATE(), GETDATE())
GO
...
SELECT N'133ae6f5-30df-4818-8ef7-bb46f25f58f4', N'<default>', N'<default>', N'#FFFFFF', N'#483D8B', N'Arial', N'#F8F8FF', N'36pt', N'#FFFFFF', N'Arial', N'#000000', N'18pt', N'#6495ED', N'Arial', N'#F8F8FF', N'10pt', N'#F0E68C', N'Arial', N'#000000', N'10pt', N'#B0C4DE', N'Arial', N'#000000', N'9pt', N'#FFFFFF', N'Arial', N'#FFFFFF', N'9pt', N'#FFFFFF', N'Arial', N'#000000', N'10pt', GETDATE(), '01/23/2019' UNION ALL
...
SELECT N'f5772c15-ad25-446c-96f4-2a21e4073321', 1, N'#FFFFFF', N'Arial', N'10', N'#000000', N'Domain Controller', N'Domain Controller', GETDATE(), GETDATE() UNION ALL
SELECT N'f5772c15-ad25-446c-96f4-2a21e4073321', 5, N'#FFFFFF', N'Arial', N'10', N'#000000', N'Active Directory Site', N'Active Directory Site', GETDATE(), GETDATE() UNION ALL
SELECT N'f5772c15-ad25-446c-96f4-2a21e4073321', 2, N'#FFFFFF', N'Arial', N'10', N'#000000', N'Windows Server', N'Windows Server', GETDATE(), GETDATE() UNION ALL
SELECT N'f5772c15-ad25-446c-96f4-2a21e4073321', 3, N'#FFFFFF', N'Arial', N'10', N'#000000', N'SQL DB Engine', N'SQL DB Engine', GETDATE(), GETDATE() UNION ALL
SELECT N'f5772c15-ad25-446c-96f4-2a21e4073321', 4, N'#FFFFFF', N'Arial', N'10', N'#000000', N'Windows Cluster', N'Windows Cluster', GETDATE(), GETDATE() UNION ALL
SELECT N'f5772c15-ad25-446c-96f4-2a21e4073321', 6, N'#FFFFFF', N'Arial', N'10', N'#000000', N'UNIX/Linux Computer', N'UNIX/Linux Computer', GETDATE(), GETDATE() UNION ALL
SELECT N'f5772c15-ad25-446c-96f4-2a21e4073321', 7, N'#FFFFFF', N'Arial', N'10', N'#000000', N'IIS Web Site', N'IIS Web Site', GETDATE(), GETDATE() UNION ALL

-- Organization Summary By Group
...
SELECT N'0b1f5a22-217e-4bd7-a8e8-c8465ba00440', 11, N'#FFFFFF', N'Arial', N'10', N'#000000', N'Organization Summary By Area', N'Dash_OrganizationSummaryByArea', GETDATE(), GETDATE() UNION ALL
SELECT N'0b1f5a22-217e-4bd7-a8e8-c8465ba00440', 12, N'#FFFFFF', N'Arial', N'10', N'#000000', N'Active Directory Server Coverage', N'Dash_ServerSummary', GETDATE(), GETDATE() UNION ALL
SELECT N'0b1f5a22-217e-4bd7-a8e8-c8465ba00440', 13, N'#FFFFFF', N'Arial', N'10', N'#000000', N'SQL Server Summary', N'Dash_OrganizationSummary_SQL', GETDATE(), GETDATE() UNION ALL
SELECT N'0b1f5a22-217e-4bd7-a8e8-c8465ba00440', 14, N'#FFFFFF', N'Arial', N'10', N'#000000', N'Alert Aging Report', N'Dash_AlertAgingReport', GETDATE(), GETDATE() UNION ALL
SELECT N'0b1f5a22-217e-4bd7-a8e8-c8465ba00440', 15, N'#FFFFFF', N'Arial', N'10', N'#000000', N'Organization Summary By Group', N'Dash_OrganizationSummaryByGroup', GETDATE(), GETDATE() UNION ALL
SELECT N'0b1f5a22-217e-4bd7-a8e8-c8465ba00440', 21, N'#FFFFFF', N'Arial', N'10', N'#000000', N'Windows Server Top 10 Performance', N'List_WindowsServersTopNPerf', GETDATE(), GETDATE() UNION ALL
SELECT N'0b1f5a22-217e-4bd7-a8e8-c8465ba00440', 22, N'#FFFFFF', N'Arial', N'10', N'#000000', N'Windows Server Logical Disk', N'Dash_OrganizationSummary_WindowsLogicalDisk', GETDATE(), GETDATE() UNION ALL
SELECT N'0b1f5a22-217e-4bd7-a8e8-c8465ba00440', 23, N'#FFFFFF', N'Arial', N'10', N'#000000', N'Windows Server Details', N'List_WindowsServers', GETDATE(), GETDATE() UNION ALL
SELECT N'0b1f5a22-217e-4bd7-a8e8-c8465ba00440', 24, N'#FFFFFF', N'Arial', N'10', N'#000000', N'Windows Server Utilization', N'List_ServerUtilization', GETDATE(), GETDATE() UNION ALL
SELECT N'0b1f5a22-217e-4bd7-a8e8-c8465ba00440', 25, N'#FFFFFF', N'Arial', N'10', N'#000000', N'Windows Server Scheduled Maintenance', N'Chart_ServerMaintenanceMode', GETDATE(), GETDATE()

-- Alert aging Dashboard
SELECT N'2ef81f28-684e-4afa-b548-c7af441dce18', 1, N'#FFFFFF', N'Arial', N'10', N'#000000', N'Active Directory Team', N'Active Directory Team', GETDATE(), GETDATE() UNION ALL
SELECT N'2ef81f28-684e-4afa-b548-c7af441dce18', 2, N'#FFFFFF', N'Arial', N'10', N'#000000', N'Windows Team', N'Windows Team', GETDATE(), GETDATE() UNION ALL
SELECT N'2ef81f28-684e-4afa-b548-c7af441dce18', 3, N'#FFFFFF', N'Arial', N'10', N'#000000', N'DBA Team', N'DBA Team', GETDATE(), GETDATE() UNION ALL
SELECT N'2ef81f28-684e-4afa-b548-c7af441dce18', 4, N'#FFFFFF', N'Arial', N'10', N'#000000', N'Web Team', N'Web Team', GETDATE(), GETDATE() UNION ALL
SELECT N'2ef81f28-684e-4afa-b548-c7af441dce18', 5, N'#FFFFFF', N'Arial', N'10', N'#000000', N'Config Mgmt Team', N'Config Mgmt Team', GETDATE(), GETDATE() UNION ALL
SELECT N'2ef81f28-684e-4afa-b548-c7af441dce18', 6, N'#FFFFFF', N'Arial', N'10', N'#000000', N'Network Team', N'Network Team', GETDATE(), GETDATE() UNION ALL
SELECT N'2ef81f28-684e-4afa-b548-c7af441dce18', 7, N'#FFFFFF', N'Arial', N'10', N'#000000', N'Monitoring Team', N'Monitoring Team', GETDATE(), GETDATE() UNION ALL
SELECT N'2ef81f28-684e-4afa-b548-c7af441dce18', 8, N'#FFFFFF', N'Arial', N'10', N'#000000', N'Unassigned', N'Unassigned', GETDATE(), GETDATE()
