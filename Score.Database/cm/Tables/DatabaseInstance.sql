CREATE TABLE [cm].[DatabaseInstance] (
    [objectGUID]         UNIQUEIDENTIFIER CONSTRAINT [DF_cm_DatabaseInstance_objectGUID] DEFAULT (newid()) NOT NULL,
...
GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_cm_DatabaseInstance_Unique]
    ON [cm].[DatabaseInstance]([ComputerGUID] ASC, [InstanceName] ASC);
