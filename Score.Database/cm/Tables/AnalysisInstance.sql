CREATE TABLE [cm].[AnalysisInstance] (
    [objectGUID]         UNIQUEIDENTIFIER CONSTRAINT [DF_cm_AnalysisInstance_objectGUID] DEFAULT (newid()) NOT NULL,
...
GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_cm_AnalysisInstance_Unique]
    ON [cm].[AnalysisInstance]([ComputerGUID] ASC, [InstanceName] ASC);
