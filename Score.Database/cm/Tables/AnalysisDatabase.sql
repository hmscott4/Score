CREATE TABLE [cm].[AnalysisDatabase] (
    [objectGUID]           UNIQUEIDENTIFIER CONSTRAINT [DF_cm_AnalysisDatabase_objectGUID] DEFAULT (newid()) NOT NULL,
...
GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_cm_AnalysisDatabase_Unique]
    ON [cm].[AnalysisDatabase]([AnalysisInstanceGUID] ASC, [DatabaseName] ASC);
