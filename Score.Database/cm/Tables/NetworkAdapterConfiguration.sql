CREATE TABLE [cm].[NetworkAdapterConfiguration] (
    ...
    CONSTRAINT [FK_NetworkAdapterConfiguration_NetworkAdapter] FOREIGN KEY ([ComputerGUID], [Index]) REFERENCES [cm].[NetworkAdapter] ([ComputerGUID], [Index])
);


GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_cm_NetworkAdapterConfiguration_Unique]
    ON [cm].[NetworkAdapterConfiguration]([ComputerGUID] ASC, [Index] ASC);
