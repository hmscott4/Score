...
GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_cm_DatabasePermission_Unique]
    ON [cm].[DatabasePermission]([DatabaseInstanceGUID] ASC, [DatabaseName] ASC, [PermissionSource] ASC, [PermissionState] ASC, [PermissionType] ASC, [Grantor] ASC, [ObjectName] ASC, [Grantee] ASC);
